        ...
        if (!empty($sms_config[ 'value' ][ 'username' ])) {
            if ($return == 1) {
                ...
                if (!empty($account_info[ 'data' ])) {
                    ...
                    $this->error('您还没有账号,即将跳转注册页面', addon_url('niusms://shop/sms/register'), '', '5');
