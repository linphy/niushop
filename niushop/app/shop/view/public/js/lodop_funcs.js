    ...
    try {
		...
		if (!LODOP) {
			...
			layer.open({
				type: 1,
				area: ['450px'],
				content: "Web打印服务CLodop未安装启动，点击这里<a class='text-color' href='http://www.lodop.net/download.html' target='_black'>去下载安装</a><br />（若此前已安装过，可<a class='text-color' href='CLodop.protocol:setup' target='_self'>点这里直接再次启动</a>）" //这里content是一个普通的String
			});
			return;
		} else {
			if (CLODOP.CVERSION < "4.0.9.9") {
                ...
                layer.open({
                    type: 1,
                    area: ['450px'],
                    content: "Web打印服务CLodop版本过低，需升级，请点击这里<a class='text-color' href='http://www.lodop.net/download.html' target='_black'>去下载安装</a><br />（若此前已安装过，可<a class='text-color' href='CLodop.protocol:setup' target='_self'>点这里直接再次启动</a>）" //这里content是一个普通的String
                });
                return;
			}
