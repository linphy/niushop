...
//        return $this;
     ...
     * @return mixed
     */
    public function imageWater($water_path, $water_opacity, $water_rotate, $water_position, $x, $y){
        $this->image = $this->imageClass->imageWater($this->image, $water_path, $water_opacity, $water_rotate, $water_position, $x, $y);
        return $this;
    }
