			...
			layui.use(['form'], function(){
        		...
        		layer.open({
					...
					yes: function (index, layero) {
						...
						self.data.list[i].categoryName =  $(".layui-layer-content input[name='category_select_id']:checked").parents('tr').find('.category-name').text();
						self.data.list[i].categoryId = $(".layui-layer-content input[name='category_select_id']:checked").attr('data-category_select_id');
						layer.closeAll()
					}
				});
			})
