    ...
    public function getMemberMemus($site_id, $custom = [])
    {
        $menus = [
            ...
            "pintuan" => [
                "tag" => "pintuan",
                "text" => "我的拼单",
                "img" => "public/uniapp/member/index/menu/default_store.png",
                "icon_type" => "icon",
                "link" => [
                    "name" => "MY_PINTUAN",
                    "title" => "我的拼团",
            ...
            "pointexchange" => [
                "tag" => "pointexchange",
                "text" => "积分兑换",
                "img" => "public/uniapp/member/index/menu/default_point_recond.png",
                "icon_type" => "icon",
                "link" => [
            ...
            "fenxiao" => [
                "tag" => "fenxiao",
                "text" => "分销中心",
                "img" => "public/uniapp/member/index/menu/default_fenxiao.png",
                "icon_type" => "icon",
                "link" => [
                ...
                "icon" => "icon-system-fenxiao-center",
                "style" => [
                    "fontSize" => 50,
                    "iconBgColor" => [
                        "#2e88fd"
            ...
            "bargain" => [
                "tag" => "bargain",
                "text" => "我的砍价",
                "img" => "public/uniapp/member/index/menu/default_bargain.png",
                "icon_type" => "icon",
                "link" => [
                    "name" => "MY_BARGAIN",
                    "title" => "我的砍价",
            ...
            "memberrecommend" => [
                "tag" => "memberrecommend",
                "text" => "邀请有礼",
                "img" => "public/uniapp/member/index/menu/default_memberrecommend.png",
                "icon_type" => "icon",
                "link" => [
                ...
                "icon" => "icon-system-member-recommend",
                "style" => [
                    "fontSize" => 50,
                    "iconBgColor" => [
                        "#b620e0"
            ...
            "presale" => [
                "tag" => "presale",
                "text" => "我的预售",
                "img" => "public/uniapp/member/index/menu/my_presale.png",
                "icon_type" => "icon",
                "link" => [
                    "name" => "PRESALE",
                    "title" => "我的预售",
            ...
            "giftcard" => [
                "tag" => "giftcard",
                "text" => "我的礼品卡",
                "img" => "public/uniapp/member/index/menu/my_giftcard.png",
                "icon_type" => "icon",
                "link" => [
                    "name" => "GIFTCARD",
                    "title" => "我的礼品卡",
                    "wap_url" => "/pages_promotion/giftcard/my_giftcard/my_giftcard",
                    "parent" => "MARKETING_LINK"
                ],
                "icon" => "icon-system-gift-card",
                "style" => [
                    "fontSize" => 40,
                    "iconBgColor" => [
                        "#b620e0"
            ...
            "divideticket" => [
                "tag" => "divideticket",
                "text" => "好友瓜分券",
                "img" => "public/uniapp/member/index/menu/my_divideticket.png",
                "icon_type" => "icon",
                "link" => [
                    "name" => "DIVIDETICKET",
                    "title" => "我的好友瓜分券",
                ...
                "icon" => "icon-system-firend-coupon",
                "style" => [
                    "fontSize" => 40,
                    "iconBgColor" => [
                        "#ff4d4d"
            ...
            "pinfan" => [
                "tag" => "pinfan",
                "text" => "拼团返利",
                "img" => "public/uniapp/member/index/menu/my_pinfan.png",
                "icon_type" => "icon",
                "link" => [
                    "name" => "PINFAN",
                    "title" => "我的拼团返利",
            ...
            "hongbao" => [
                "tag" => "hongbao",
                "text" => "裂变红包",
                "img" => "public/uniapp/member/index/menu/my_hongbao.png",
                "icon_type" => "icon",
                "link" => [
                    "name" => "HONGBAO",
                    "title" => "我的裂变红包",
                ...
                "icon" => "icon-system-liebian-red-envelope",
                "style" => [
                    "fontSize" => 50,
                    "iconBgColor" => [
                        "#fa6400"
            ...
            "blindbox" => [
                "tag" => "blindbox",
                "text" => "盲盒",
                "img" => "public/uniapp/member/index/menu/my_box.png",
                "icon_type" => "icon",
                "link" => [
                    "name" => "BLINDBOX",
                    "title" => "我的盲盒",
