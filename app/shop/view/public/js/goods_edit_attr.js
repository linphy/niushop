...
function refreshAttrValueList() {
	...
	for (var i = 0; i < attrValueList.length; i++) {
		...
		h += '<tr>';
		h += '<td><input name="attr_value_name" type="text" value="' + item.attr_value_name + '" data-index="' + i + '" placeholder="请输入参数名称" lay-verify="attr_value" class="layui-input len-mid" autocomplete="off" maxlength="10"></td>';
