...
--
-- `pc_floor_block_copy1`
--
DROP TABLE IF EXISTS pc_floor_block_copy1;
...
CREATE TABLE poster (
  ...
  nickname_font_size decimal(10, 2) NOT NULL COMMENT '昵称字体大小',
...
CREATE TABLE verify (
  ...
  expire_time int(11) NOT NULL COMMENT '核销有效期 0永久',
...
CREATE TABLE promotion_pinfan (
  ...
  reward_type tinyint(1) NOT NULL COMMENT '拼团成功但是未发货奖励1消费余额2现金红包3优惠券4.积分',
...
CREATE TABLE promotion_jielong_goods (
  ...
  jielong_id int(11) NOT NULL COMMENT '接龙活动表ID',
  site_id int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
CREATE TABLE promotion_jielong (
  ...
  jielong_name varchar(50) NOT NULL COMMENT '接龙活动名称',
  site_id int(11) NOT NULL DEFAULT 0 COMMENT '站点ID',
...
CREATE TABLE promotion_hongbao_group (
  ...
  group_member_ids varchar(255) NOT NULL COMMENT '组中人id（发放券的人）',
...
CREATE TABLE poster_template (
  ...
  template_json text NOT NULL COMMENT '拓展json',
  create_time int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (template_id)
)
ENGINE = INNODB,
...
CREATE TABLE poster_muban (
  ...
  qrcode_width decimal(10, 0) NOT NULL,
  qrcode_height decimal(10, 0) NOT NULL,
  qrcode_top decimal(10, 0) NOT NULL,
  qrcode_left decimal(10, 0) NOT NULL,
...
-- `pc_floor_block_copy1`
--
CREATE TABLE pc_floor_block_copy1 (
  id int(11) NOT NULL AUTO_INCREMENT COMMENT '数据ID',
...
CREATE TABLE member_level (
  ...
  charge_rule text NOT NULL COMMENT '付费规则',
  charge_type int(1) NOT NULL COMMENT '付费类型 0付款 1充值',
...
CREATE TABLE goods_recommend (
  ...
  type int(11) NOT NULL COMMENT '类型  1一周销售排名    2一月销售排名    3自定义推荐',
  category_id int(11) NOT NULL COMMENT '商品分类ID',
  goods_ids varchar(255) NOT NULL COMMENT '自定义推荐     商品ID',
...
CREATE TABLE goods_import_record (
  ...
  fail_data text NOT NULL COMMENT '失败数据',
  data text NOT NULL COMMENT '导入原始数据',
  PRIMARY KEY (id)
)
ENGINE = INNODB,
CHARACTER SET utf8,
...
CREATE TABLE goods_community_qrcode (
  ...
  qr_img varchar(255) NOT NULL COMMENT '社群二维码图片',
...
CREATE TABLE giftcard_transfer_record (
  ...
  record_id int(11) NOT NULL COMMENT '卡密id',
  ...
  has_member_id int(11) NOT NULL COMMENT '持有人id',
  ...
  receive_member_id int(11) NOT NULL COMMENT '领取人id',
  create_time int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  site_id int(3) NOT NULL COMMENT '站点id',
...
CREATE TABLE giftcard_order (
  ...
  card_id int(11) NOT NULL COMMENT '电子卡id',
  card_price decimal(10, 2) NOT NULL COMMENT '单价',
  num int(3) NOT NULL COMMENT '购买数量',
...
CREATE TABLE express_delivery_package (
  ...
  order_id int(11) NOT NULL DEFAULT 0 COMMENT '订单id',
  order_goods_id_array varchar(1000) NOT NULL DEFAULT '' COMMENT '订单项商品组合列表',
  goods_id_array text NOT NULL COMMENT '商品组合列表',
  package_name varchar(50) NOT NULL DEFAULT '' COMMENT '包裹名称  （包裹- 1 包裹 - 2）',
...
CREATE TABLE config (
  ...
  value text NOT NULL COMMENT '配置值json',
...
CREATE TABLE blindbox (
  ...
  new_price decimal(10, 2) NOT NULL COMMENT '新人拆盒价',
...
CREATE TABLE adv (
  ...
  adv_url text NOT NULL COMMENT '广告链接',
