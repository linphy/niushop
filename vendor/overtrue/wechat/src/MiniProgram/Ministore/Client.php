...
class Client extends BaseClient
{
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
    public function getAftersale($order_id, $out_order_id, $openid){
        $params = array(
            'order_id' => $order_id,
            'out_order_id' => $out_order_id,
            'openid' => $openid,
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
    public function updateAftersale($order_id, $out_order_id, $out_aftersale_id, $status, $finish_all_aftersale){
        $params = array(
            'order_id' => $order_id,
            'out_order_id' => $out_order_id,
            'out_aftersale_id' => $out_aftersale_id,
            'status' => $status,
            'finish_all_aftersale' => $finish_all_aftersale,
        );
