...
return [
    'website_name' => 'NIUSHOP',
    // logo
    'logo' => 'niushop_logo.jpg',
    // 官网地址
    'website_url' => 'https://www.niushop.com',
    // 论坛地址
    'bbs_url' => 'https://www.niushop.com/web/community/index.html',
    // 编译帮助手册
    'build_manual' => 'https://www.kancloud.cn/niushop/niushop_v6/3224842',
    // 安装协议
    'agreement' => '<strong>版权所有 (c)2016，Niushop开源商城团队保留所有权利。</strong>
    <p>
    ...
    // 站点名称
    'admin_site_name' => 'NIUSHOP V6',
    // admin 端登录页默认图
    'admin_login_bg' => 'install/img/niushop_login_index_left.jpg',
    // admin 端默认logo
    'admin_logo' => 'install/img/niushop_logo.jpg'
];
