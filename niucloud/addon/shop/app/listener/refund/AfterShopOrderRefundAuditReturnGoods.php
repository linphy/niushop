 ...
 * 退款完成后操作
 */
class AfterShopOrderRefundAuditReturnGoods
{
    ...
    public function handle($data){
        ...
        //日志
        if(in_array($refund_data['status'], [OrderRefundDict::STORE_REFUSE_TAKE_REFUND_GOODS_WAIT_BUYER, OrderRefundDict::STORE_AGREE_REFUND_WAIT_TRANSFER])){
        ...
        (new CoreRefundLogService())->add([
            ...
            'main_type' => OrderRefundLogDict::MEMBER,//todo  可以是传入的
            'main_id' => $main_id,
            'type' => $log_type,
            'content' => ''
        ]);
