 ...
 *
 */
class ShopOrderDidcountCreate
{

    public function handle($data)
    {
        Log::write('订单ShopOrderDidcountCreate' . json_encode($data));
        try {
            //积分商城兑换积分扣除业务
            if (isset($data['data']) && isset($data['order_object']) && $data['data']['discount_type'] == 'exchange') {
