...
use addon\diy_default2\event\UseTemplate;
...
class TemplateInfo
{
    ...
    public function handle($params)
    {
        if ($params[ 'name' ] == '' || $params[ 'name' ] == 'official_default_plane') {
            ...
            $info = [
                'title' => '官方模板二',
                'name' => 'official_default_plane',
                'cover' => __ROOT__ . '/addon/diy_default2/shop/view/public/img/cover.png',
                'preview' => __ROOT__ . '/addon/diy_default2/shop/view/public/img/preview.png',
