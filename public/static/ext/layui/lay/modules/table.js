...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
	...
	var t = layui.$,
		...
		H = [
			...
			'<i class="common-loading-layer layui-icon layui-icon-loading layui-anim layui-anim-rotate layui-anim-loop"></i>', "</div>", "{{# } }}",
			...
			"</table>", "</div>", "{{# } }}", '<div class="table-bottom">','<div class="layui-table-bottom-tool">',
	...
	j.prototype.config = {
			...
			if (a.index = e.index, e.key = a.id || a.index, n[0] && n.remove(), l.after(o), e.layTool = o.find(m), e.layBottomTool =
				o.find(mb), e.layBox = o.find(g), e.layHeader = o.find(x), e.layMain = o.find(C), e.layBody = o.find(k), e.layFixed =
				o.find(w), e.layFixLeft = o.find(T), e.layFixRight = o.find(A), e.layTotal = o.find(L), e.layPage = o.find(N), e.renderToolbar(),
				e.fullSize(),
				a.cols.length > 1) {
		...
		}, j.prototype.renderBottomToolbar = function() {
			
			//底部工具栏
			var e = this,
				a = e.config,
				n = e.layBottomTool.find(".layui-table-bottom-tool-temp");
			...
			if (i.startTime = (new Date).getTime(), a.url) {
				...
				a.contentType && 0 == a.contentType.indexOf("application/json") && (d = JSON.stringify(d)), i.loading(), t.ajax({
					...
					data: d,
					dataType: "json",
					async : (a.async != undefined) ? a.async : true,
					headers: a.headers || {},
					success: function(t) {
			...
			return d.cache[c.key] = y, c.layPage[0 == o || 0 === y.length && 1 == n ? "addClass" : "removeClass"](f), r ? g() :
				0 === y.length ? (c.renderForm(), c.errorView(s.text.none)) : (c.layFixed.removeClass(f), g(), c.renderBottomToolbar(), c.renderForm(),
					c.renderTotal(y),
			...
			var ee = this,
				tt = e.config,
				ii = ee.layBottomTool.find('input[name="layTableCheckbox"]'),
				aa = function(i) {
			...
			}), i.layBottomTool.on("click", "*[lay-event]", function(e) {
				var i = t(this),
					c = i.attr("lay-event");
				layui.event.call(this, y, "bottomToolbar(" + p + ")", t.extend({
					event: c,
					config: a
				}, {}))
			...
			i.elem.on("click", 'input[name="layTableCheckbox"]+', function() {
				...
				// 自定义
				o ? a.each(function(e, t) {
					layui.event.call(this, y, "checkboxChange(" + p + ")", v.call(this, {
						checked: n,
					}))
				}) : layui.event.call(e[
						0], y, "checkboxChange(" + p + ")", v.call(e[0], {
						checked: n,
					}))
