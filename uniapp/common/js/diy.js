...
export default {
	data() {
		return {
			...
			isChangeStore: true, // 是否允许切换门店，true：允许，false：拒绝，只有在首页才能切换门店
	...
	onHide() {
		...
		this.isChangeStore = false; // 切换页面，停止切换门店
