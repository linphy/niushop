					...
					<view class="site-body">
						...
						<view class="goods-item" v-for="(goodsItem, goodsIndex) in calculateGoodsData.goods_list" :key="goodsIndex">
							...
							<view
								...
								v-if="calculateGoodsData.goods_list[goodsIndex].member_card_list"
							...
							<view class="goods-form" v-if="goodsData.goods_list[goodsIndex].goods_form" @click="editForm(goodsIndex)">
								<ns-form
									:data="goodsData.goods_list[goodsIndex].goods_form.json_data"
									ref="goodsForm"
									:custom-attr="{ sku_id: goodsItem.sku_id, form_id: goodsData.goods_list[goodsIndex].goods_form.id }"
								></ns-form>
								<text class="cell-more iconfont icon-right"></text>
